...
impl ScyllaDb {
    ...
    async fn create_user_table(&self) -> Result<()> {
        ...
        "#;
        self.session.query_unpaged(create_user_table, &[]).await?;

        Ok(())
    }

    async fn create_order_table(&self) -> Result<()> {
        let create_order_table = r#"
        ...
        self.session.query_unpaged(create_order_table, &[]).await?;
        Ok(())
    }
    ...
    async fn create_trade_table(&self) -> Result<()> {
      ...
      "#;
        self.session.query_unpaged(create_trade_table, &[]).await?;
        Ok(())
    }
     ...
     async fn create_market_table(&self) -> Result<()> {
      ...
      "#;
        self.session.query_unpaged(create_market_table, &[]).await?;
        Ok(())
    }
